...
#'
#' @param initial_amount A number representing the amount of servings of curry the customer wants. MUST be <= 2.
#' @param customer_name A string representing that is the customer's name
#'
...
curry_amount_except_pentuple_it <- function(initial_amount, customer_name) {
  ...
  if (initial_amount <= 2) {
    warning("You only want ", initial_amount, " servings of curry?? Please enter higher amount, you want more.")
  }
